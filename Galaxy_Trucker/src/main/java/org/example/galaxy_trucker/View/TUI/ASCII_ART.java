...
//    /**
//     * Represents the current phase of acceptance or confirmation in the game's flow or logic.
//     * This variable is used to track and determine actions or states related to the acceptance phase.
//     */
...
//
//    /**
//     * Represents the phase in the system where crew members can be added.
//     * This variable is used to identify and manage the specific phase related to adding crew in the broader application workflow.
//     */
//    public static String AddCrewPhase = "";
//
//
//    /**
//     * Represents the building phase in the current ASCII art game representation.
//     * This phase is part of the overall game state, detailing the building process
//     * or actions related to a specific part of the gameplay.
//     *
//     * It is a static string field initialized as empty, designed to hold a value
//     * or description pertaining to the building phase during the game's execution.
//     */
//    public static String BuildingPhase = "";
//
//
//    /**
//     * Represents a specific phase called "Check Validity Phase" within the game's process
//     * or logic flow, likely used for validating certain conditions, states, or actions.
//     *
//     * Stored as a static string variable, it could serve as an identifier or descriptive label
//     * for this particular phase in the program's operation.
//     */
//    public static String CheckValidityPhase = "";
//
//
//    /**
//     * Represents the phase in a game where the player is required to choose their position.
//     * This phase might involve selecting a starting position, placement on the board, or
//     * some other positional decision necessary for gameplay progression.
//     */
//    public static String ChoosePositionPhase = "";
//
//
//    /**
//     * Represents an ASCII art representation for the phase "Choose Planet" in a stylized format.
//     * This variable is intended to visually depict the phase name using ASCII art, which can be
//     * used in terminal-based games or applications for enhanced visual appeal.
//     */
...
//
//    /**
//     * Represents the phase in a process where energy is consumed.
//     * This string is used to denote or identify the energy consumption phase
//     * within the flow of operations in the ASCII_ART class.
//     */
...
//
    ...
    /**
     * A static string variable representing an ASCII art depiction of a large meteor.
     *
     * This variable contains a multi-line string that visually illustrates
     * a meteor using various characters*/
    ...
    /**
     * A static ASCII art string representation of a small meteor.
     * This variable contains a predefined visual depiction using ASCII characters.
     */
    ...
    /**
     * A static string variable representing an ASCII art depiction of an abandoned station.
     * This string contains visual information formatted with newline characters and spaces
     * to create an image resembling an abandoned structure. The ASCII art provides
     * a visual representation that can be used within the context of the containing class
    ...
    /**
     * A static string representing an ASCII art depiction of an abandoned station.
     * The ASCII art is used as a visual representation within the context of the application.
     * It is a multi-line string formatted to display a graphical layout resembling an abandoned station.
     */
    public static String AbandonedStation =
            "\n" +
                    "\n" +
    ...
    /**
     * The `bigBolt` variable represents a large ASCII art depiction
     * of a bolt, commonly used for visual or decorative purposes
    ...
    /**
     * A static ASCII art representation of a small bolt design.
     * The artwork consists of characters arranged to visually depict the shape of a small bolt.
     */
    ...
    /**
     * Represents an ASCII art depiction of a meteor shard.
     *
     * This variable provides a visual representation of a meteor fragment using ASCII
     * characters, which can be utilized in contexts such as console-based games or
     * other text-based user interfaces.
     *
     * The art includes a stylized meteor shard design with spacing preserved for
     * proper rendering in monospaced fonts.
     */
    ...
    /**
     * A string containing an ASCII art representation of the Pirates.
     * This string encapsulates a visual design which may represent pirates or serve as
     * a decorative element in a textual interface or game involving pirate-related themes.
     */
    ...
    /**
     * Represents an ASCII art of a slaver ship or entity in string format.
     */
    ...
    /**
     * A string variable storing an ASCII art representation, primarily displaying
     * an elaborate visual of a symbolic figure or decorative element.
     *
     * The string is preformatted using special characters for alignment and is intended
     * to serve as a visual element within the application, potentially representing smugglers
     * in the context of the containing class or related gameplay features.
     *
     * This variable is static and immutable, providing a consistent ASCII art graphic
     * that can be used throughout the application without modification.
     */
