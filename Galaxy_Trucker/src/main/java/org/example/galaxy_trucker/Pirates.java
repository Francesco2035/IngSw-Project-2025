...
public class Pirates extends Card{
    ...
    public Pirates(int level, int time, GameBoard board, int Reward, int Requirement, ArrayList<IntegerPair> Punsihment){
        super(level, time, board);
        this.requirement = Requirement;
        this.reward = Reward;
//        this.PunishmentCouple = Punsihment;
    }
...
//        for(int i=0;i<PunishmentCouple.size();i++){
...
//                AttackNumber=0;
//
//                while(PunishmentCouple.size()>AttackNumber) { // faccio tutti gli atttacchi
//                    Line=Lines[AttackNumber]; // prendo la linea da attaccà
//
//                    if (PunishmentCouple.get(AttackNumber).getFirst() == 0) { //sinistra
//                        Movement = 0;
//
...
//                        }
//                    }
//                    if (PunishmentCouple.get(AttackNumber).getFirst() == 1) {//sopra
//                        Movement = 0;
//                        while (Movement < 10 && Attacked == false) {
...
//                        }
//                    }
//                    if (PunishmentCouple.get(AttackNumber).getFirst() == 2) {// destra
//                        Movement = 9;
